...
export function FreeTools({ preview = false }) {
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="space-y-12" aria-label="Free Premium Trading Tools Download">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mx-auto max-w-2xl text-center mb-12">
            <h2 className="font-display text-4xl font-bold sm:text-5xl">
              Free <span className="text-gradient-gold">Premium Trading Tools</span>
            </h2>
            <p className="mt-4 text-muted-foreground">Download professional forex trading bots and gold scalper strategies</p>
          </div>
        </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <img
                ...
                className="relative h-auto max-w-sm rounded-lg shadow-2xl"
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              <button
                ...
                className="group inline-flex items-center gap-2 rounded-lg bg-[oklch(0.74_0.17_78)] px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all hover:shadow-xl hover:opacity-90"
              >
              ...
              <button
                ...
                className="group inline-flex items-center gap-2 rounded-lg border border-border/60 bg-secondary/50 px-6 py-3 text-sm font-medium text-muted-foreground transition-all hover:border-primary/40 hover:text-foreground"
              >
                Learn More
      ...
      {showMasteryModal && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          <div className="bg-background border border-border/60 rounded-xl max-w-2xl max-h-[90vh] overflow-y-auto w-full shadow-2xl">
            {/* Header */}
            <div className="sticky top-0 flex items-center justify-between bg-background border-b border-border/40 p-6">
              <h2 className="font-display text-2xl font-bold">How MasteryAI Gold Scalper Works</h2>
              <button
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-amber-600 dark:text-amber-400">Trading Strategies</h3>

                {/* Multi-Timeframe */}
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">1. Multi-Timeframe Weighted Voting System</h4>
            ...
            {/* Footer */}
            <div className="border-t border-border/40 p-6 bg-secondary/30">
              <button
                onClick={() => setShowMasteryModal(false)}
      ...
      {preview && (
        <div className="mt-12 text-center">
          <Link
            to="/free-tools"
            className="inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-glow-primary)] transition-all hover:opacity-90 hover:shadow-lg"
          >
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              <button
                ...
                className="group inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-glow-primary)] transition-all hover:shadow-xl hover:opacity-90"
              >
                <Download className="h-4 w-4" />
                Download Bot
              </button>
      ...
      {showGTMModal && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          <div className="bg-background border border-border/60 rounded-xl max-w-2xl max-h-[90vh] overflow-y-auto w-full shadow-2xl">
            {/* Header */}
            <div className="sticky top-0 flex items-center justify-between bg-background border-b border-border/40 p-6">
              <h2 className="font-display text-2xl font-bold">How GTM Pro Gold Scalper Works</h2>
              <button
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-primary">1. Multi-Timeframe Analysis (D1 + H4 + H1)</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-primary">2. Hybrid Indicator Strategy: MACD + Bollinger Bands + Volume</h3>
                
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">MACD (Moving Average Convergence Divergence)</h4>
                  <ul className="space-y-1.5 ml-4">
                    {[
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">Bollinger Bands (Volatility & Overbought/Oversold)</h4>
                  <ul className="space-y-1.5 ml-4">
                    {[
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">Volume Analysis</h4>
                  <ul className="space-y-1.5 ml-4">
                    {[
              ...
              {/* Entry Conditions */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-primary">3. Entry Conditions</h3>
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">Swing Trading Entries (Conservative)</h4>
                  <ul className="space-y-1.5 ml-4">
                    {[
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">Strategy Modes</h4>
                  <ul className="space-y-1.5 ml-4">
                    {[
                      "SingleRound: One trade per direction",
              ...
              {/* Exit Strategy */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-primary">4. Exit Strategy</h3>
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">Take Profit & Stop Loss</h4>
                  <ul className="space-y-1.5 ml-4">
                    {[
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">Trailing Stop</h4>
                  <ul className="space-y-1.5 ml-4">
                    {[
              ...
              {/* Risk Management */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-primary">5. Risk Management</h3>
                <ul className="space-y-1.5 ml-4">
                  {[
              ...
              {/* Trade Timing */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-primary">6. Trade Timing & Execution</h3>
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">Swing Focus</h4>
                  <ul className="space-y-1.5 ml-4">
                    {[
            ...
            <div className="border-t border-border/40 p-6 bg-secondary/30">
              <button
                onClick={() => setShowGTMModal(false)}
                className="w-full rounded-lg bg-primary hover:opacity-90 text-primary-foreground font-semibold py-2.5 transition-colors"
              >
                Close
              </button>
            </div>
